...
const UserProfile = () => {
  ...
  return (
    <div className='grid grid-cols-[1fr_4fr]'>
      {/* Avatar + Usernames */}
      <div className='flex flex-col bg-gray-300 justify-between items-center gap-2 h-full'>
        <div className='flex flex-col justify-center items-center gap-2 flex-grow'>
          <Avatar alt='Remy Sharp' sx={{ width: 90, height: 90 }} />
          <h1 className='text-2xl tracker-wide font-semibold '>
            {user.username}
          </h1>
        </div>
        <div
          onClick={() => navigate('/forgot-password')}
          className='flex items-center bg-primary text-white rounded-md px-2 py-3 hover:bg-secondary cursor-pointer mb-2'
        >
