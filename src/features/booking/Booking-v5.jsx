    ...
    switch (stepIndex) {
      case 0:
        return (
          <Grid item md={5} xs={12}>
            <div className='flex flex-col gap-5 justify-center items-center gap-x-3 border-2 rounded-lg border-orange-200 p-5 w-[80rem] h-[50vh]'>
      ...
      case 1:
        return (
          <Grid item md={7} xs={12}>
            <div className='flex flex-col align-middle items-center justify-center gap-y-5 border-2 rounded-lg border-orange-200 p-3 w-[80rem] h-[50vh]'>
              <h1 className='text-center text-primary font-semibold'>
        ...
        return (
          <>
            <Grid item md={6} xs={12}>
              <div>
                <div className='px-1 border-solid border-2 border-orange-200 rounded-large w-[80rem]  items-center h-[70vh]'>
      ...
      case 3:
        return (
          <>
            <Grid item md={6} xs={12}>
              <div className='px-6 border-solid border-2 border-orange-200 rounded-large w-[80rem] flex flex-col items-center justify-center  h-[50vh]'>
                <h1 className='text-center text-primary font-semibold'>
                ...
                <div className='mt-4 h-screen overflow-y-auto flex flex-wrap'>
                  {tables.map((table, idx) => {
                    return (
                      <div key={idx} className='w-[15rem] p-2'>
                        <div
                          onClick={() =>
                            handleCheckTable(idx, table.tableTypeId)
                          }
                          className={`bg-orange-500 my-10 px-4 py-3 border-solid rounded-large shadow-md flex flex-col justify-between items-center cursor-pointer hover:bg-orange-300 focus:ring-8 focus:ring-orange-500 ${
                            table.maxSeat <
                            (getValues('adult') || 0) +
      ...
      <div className='flex mt-5 justify-center items-center gap-5'>
        ...
        {timeFrom && timeTo && (
          <SaveBookingInfo
            ...
            value={`${convertTo24Hour(timeFrom).toLocaleTimeString('en-US', {
              hour: '2-digit',
              minute: '2-digit',
              hour12: true,
        ...
        {chosenAreaName && chosenAreaName !== 0 && (
          <SaveBookingInfo IconComponent={FaStairs} value={chosenAreaName} />
        )}

        {chosenTableName && chosenTableName !== 0 && (
          <SaveBookingInfo IconComponent={MdTableBar} value={chosenTableName} />
        )}
      </div>

      {/* <h1 className='text-xl font-bold '>More Page</h1> */}
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className='container mx-auto px-4 grid grid-cols-[1fr_2fr] auto-cols-auto'>
          <div className='my-10 overflow-y-auto max-h-[80vh]'>
            <Stepper activeStep={activeStep} orientation='vertical'>
              {steps.map((label) => (
                <Step key={label}>
                  <StepLabel style={{ fontSize: '5em' }}>{label}</StepLabel>
                </Step>
              ))}
            </Stepper>
          </div>
          <div className='bg-white shadow rounded-lg p-6 flex flex-col items-center justify-center relative px-5 '>
            {activeStep === steps.length ? (
              <>
                <div className='px-1 border-solid border-2 border-orange-200 rounded-large w-[80rem]  items-center h-[85vh] flex flex-col gap-7'>
