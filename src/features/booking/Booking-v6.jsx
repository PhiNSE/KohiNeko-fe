...
const Booking = () => {
  ...
  return (
    <PageTransition>
      ...
      >
        <div className='flex gap-3 items-center bg-orange-900 w-fit rounded-lg px-3 py-1 shadow-md hover:shadow-lg transition-shadow duration-200 ease-in cursor-pointer hover:text-orange-500'>
          <FaLongArrowAltLeft
            size='2rem'
      ...
      <div className='flex mt-5 mb-2 gap-5 justify-between px-5'>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className='container mx-auto px-4 grid grid-cols-[auto_2fr] auto-cols-auto'>
          <div className='my-10 overflow-y-auto max-h-[80vh] min-w-[200px]'>
          ...
          <div className='bg-white shadow-lg rounded-lg p-6 flex flex-col items-center justify-center relative px-5 overflow-x-hidden'>
            {' '}
