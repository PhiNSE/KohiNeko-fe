...
function getSteps() {
  return ['No People', 'Datetime', 'Area Booking', 'Table Booking'];
}
...
const Booking = () => {
  ...
  const handleBack = () => {
    setTimeFrom(localStorage.getItem('timeFrom'));
    setTimeTo(localStorage.getItem('timeTo'));
        ...
        <div className='container mx-auto px-4 grid grid-cols-[1fr_2fr] auto-cols-auto'>
          ...
          <div className='bg-white shadow rounded-lg p-6 flex flex-col items-center justify-center relative px-5 '>
            {activeStep === steps.length ? (
              <>
                <div className='px-1 border-solid border-2 border-orange-200 rounded-large w-[80rem]  items-center h-[85vh] flex flex-col gap-3'>
                  <h1 className='text-center text-primary font-semibold'>
                    How many people are you intend to visit ?
                  </h1>
