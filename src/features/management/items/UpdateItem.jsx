      ...
      <div className="mt-2">
        ...
        <FormControl fullWidth margin="normal">
          ...
          <Select
            ...
            required
            value={itemType}
            onChange={(event) => setValue("itemType", event.target.value)}
            {...register("itemType")}
          >
            <MenuItem value="drink">Drink</MenuItem>
            <MenuItem value="foods">Food</MenuItem>
            <MenuItem value="cat foods">Cat Food</MenuItem>
            <MenuItem value="toys">Cat Toy</MenuItem>
          </Select>
        </FormControl>

        <Typography variant="h6" sx={{ pb: 1 }}>Image</Typography>
        <GetImage
          key={key1}
          fileId={"1"}
