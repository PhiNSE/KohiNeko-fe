      ...
      case 0:
        return (
          <div className='flex flex-col items-center justify-center h-[70vh] gap-3'>
            ...
            <input
              className='p-2 border border-primary rounded-md focus:outline-none focus:ring-2 focus:ring-orange-900 w-full md:w-full'
              type='email'
    ...
    <>
      {isLoading ? (
        ...
        <div className='grid grid-cols-[1fr_4fr] justify-items-center align-items-center w-full h-screen'>
          ...
          <div className='bg-orange-50 w-full flex flex-col justify-center items-center'>
            <h1 className='text-primary text-4xl font-semibold tracking-wider'>
              Coffee Shop Manager Sign Up Form
            </h1>
            <p className='text-center  mt-2 text-lg text-secondary'>
              This sign up form is exclusively for managers of a coffee shop.
